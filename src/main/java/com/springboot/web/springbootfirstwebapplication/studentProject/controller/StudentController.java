...
public class StudentController {
	...
	public static List<StudentDTO> students = new LinkedList<StudentDTO>();
	
	@PostMapping("/setStudent")
	public ResponseEntity<String> addStudent(@RequestBody StudentDTO studentdto)
	{
		studentService.addStudent(students, studentdto);
		return new ResponseEntity<String>(studentdto.getName() + " is added successfull", HttpStatus.OK);
	}
	 ...
	 * Student st = studentService.getStudentById(students,id); 
	 * if(!(null==st)) 
